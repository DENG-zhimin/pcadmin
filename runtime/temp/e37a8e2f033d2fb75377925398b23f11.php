<?php /*a:3:{s:66:"/var/www/html/compmgmt/application/padmin/view/index/software.html";i:1585225234;s:65:"/var/www/html/compmgmt/application/padmin/view/public/header.html";i:1585799193;s:65:"/var/www/html/compmgmt/application/padmin/view/public/footer.html";i:1565994208;}*/ ?>
<!DOCTYPE html>
<html >
<head>
    <meta charset="utf-8">
	...
	<div class="layui-row layui-col-space10">
		...
		<div class="layui-col-md8">
			<form action="#" onsubmit="return false">
				<input  id="keyword"  placeholder="可按软件名称，类别名称等搜索">
	  ...
	  layui.use(['table', 'form','layer'], function () {
	      ...
	      var table = layui.table;
			...
			table.render({
				...
				, url: "<?php echo MyUrl('padmin/index/getSoftwareList'); ?>" //数据接口
				, page: true //开启分页
				,limit:20
				, cols: [[ //表头
					...
					,{field:'manufacturer',title:'厂商',sort:true}
		...
		detail = function(d){
			...
			var ud = layer.open({
				...
				,shade:0.6
				,anim:2
				,content: "<?php echo MyUrl('padmin/index/softwareInfo'); ?>"  + "?id=" + id
				,id:"one"
				,offset: 'auto'
				,btnAlign: 'c'
				,yes: function(){
		...
		del = function(d){
            ...
            $.ajax({
                url:"<?php echo MyUrl('padmin/index/delSoftware'); ?>",
                cache:false,
                type:"POST",
                dataType:"json",
                data: {'id': d.id},
