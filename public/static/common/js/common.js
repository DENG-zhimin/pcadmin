...
function formatUnixtimestamp(unixtimestamp) {
	...
	res = year + "-" + month.substring(month.length - 2, month.length) + "-" + date.substring(date.length - 2, date.length) +
	                ...
	                success:function(result)
	                {
	                	...
	                	} else if(request_type == 'ajax-url' || request_type == 'ajax-reload')
	                	{
		            		...
		            		if(result.code == 0)
		            		{
		            			...
		            			{
		            				Prompt(result.msg, 'success');
		            				if (request_value == 'parent-reload') 
		            				{
		            					setTimeout(function()
										{
